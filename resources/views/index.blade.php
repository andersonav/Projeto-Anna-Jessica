            ...
            <ul class="nav-menu">
                ...
                <li class="dropdown show">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        ...
                        <a class="dropdown-item item-user" href="{{ route('adminRelatorio') }}"><i
                        ...
                        <a class="dropdown-item item-user" href="{{ route('userRelatorio') }}"><i
                                class="fa fa-file"></i> Relatórios</a><br> @endif
    ...
    <section id="schedule" class="section-with-bg">
        <div class="container wow fadeInUp">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                @if($count == 0)
                <li class="nav-item">
                    <a class="nav-link active" href="#{{$data->mes}}-{{$data->dia}}-{{$data->ano}}" role="tab"
                        data-toggle="tab">Dia {{$data->dia}}/{{$data->numeroMes}}/{{$data->ano}}</a>
                </li>
                @else
                <li class="nav-item">
                    <a class="nav-link" href="#{{$data->mes}}-{{$data->dia}}-{{$data->ano}}" role="tab"
                        data-toggle="tab">Dia {{$data->dia}}/{{$data->numeroMes}}/{{$data->ano}}</a>
                </li>
                @endif
                @php
            ...
            <div class="tab-content row justify-content-center">
                ...
                <div role="tabpanel" class="col-lg-9 tab-pane fade show {{$textActive}}"
                    id="{{$agenda->mes}}-{{$agenda->dia}}-{{$agenda->ano}}">
                    @php
                    ...
                    <div class="row schedule-item">
                        <div class="col-md-3">
                            <time>{{ date("h:i", strtotime($horasInicio[$cont])) }}</time><br><span>{{$cidades[$cont]}}</span>
                        </div>
                        <div class="col-md-9">
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner">
                            ...
                            @if($count == 0)
                            <div class="carousel-item active">
                                <img class="d-block w-100" src="img/anuncios/{{$anuncio->imagem}}" alt="First slide"
                                    id="imgAnu">
                            </div>
                            @else
                            <div class="carousel-item">
            ...
            <div class="row">
                    ...
                    <div class="hotel">
                        ...
                        <div class="stars">
                            ...
                            <div class="text-center"><button type="submit" class="btnmodal" data-toggle="modal"
                                    data-target="#buy-ticket-modalspots" data-ticket-type="premium-access">Ouça
                                    Agora</button>
                            </div><br>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="hotel">
                        ...
                        <div class="stars">
                            <p>Trabalhamos com divulgação por meio das mídias sociais, com cobertura textual, áudio
                                visual, fotográfica e imagens aéreas, que aproxima seu publico da sua empresa, além de
                                aumentar a visibilidade da sua marca e seu alcance.</p>
                            <div class="text-center"><button type="submit" class="btnmodal" data-toggle="modal"
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="fa-ul">
                                ...
                                <li><span class="fa-li"><i class="fa fa-check"></i></span>{{$item}}: <a
                                        href="{{ $link[$contador++] }}" Target=”_blank”>click
                                        aqui</a></li>
                                @endif
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="javascript:void(0);" id="myFormLogin">
                        ...
                        <div class="text-left">
                            <a class="btn-link" data-toggle="modal" data-target="#modal-remmember-pass"
                                data-ticket-type="premium-access" onclick="closeModalLogin();"><b>Esqueci minha
                                    senha!</b></a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <img src="{{asset('img/postifolio/cerimonia.jpeg')}}" alt="Hotel 1" class="img-fluid"
                                id="portcont">
                        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <audio src="{{asset('audios/1.mp3')}}" controls loop
                                style="width: 100%; margin-bottom:15px"></audio>
                            <audio src="{{asset('audios/2.mp3')}}" controls loop
                                style="width: 100%; margin-bottom:15px"></audio>
                            <audio src="{{asset('audios/3.mp3')}}" controls loop
                                style="width: 100%; margin-bottom:15px"></audio>
                        </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-12" id="Sp">
                            ...
                            <button type="submit" class="btnilustre2">
                                <b><i class="fa fa-calendar" aria-hidden="true"></i> Data do Evento</b>
                            </button>
                            <h7><b>{{ date("d/m/Y", strtotime($item->data)) }}</b></h7>
    ...
    <section id="venue" class="buy-tickets wow fadeInUp">
        ...
        <div class="container-fluid">
            ...
            <div class="row no-gutters">
                ...
                @foreach ($selectKits as $item)
                <div class="col-lg-12 venue-info horarioEventoDestaque" id="{{ $item->dia }}"
                    role="{{ $item->numeroMes }}" alt="{{ $item->numeroAno }}">
                    <div class="row justify-content-center">
                        <div class="col-lg-6">
                        ...
                        <div class="col-11 col-lg-6" id="insc">
                            <div class="col-11 col-lg-12">
                                ...
                                <div class="col-11 col-lg-12">
                                    ...
                                    <div class="text-center">
                                        @auth
                                        <a class="aInscBtn" href="{{route('compra-kit')}}"><button type="button"
                                                class="btnmodal inscBtn">Inscreva-se
                                                ja!</button></a> @else
