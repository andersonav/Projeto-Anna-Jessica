            ...
            <div class="container">
                ...
                <nav id="nav-menu-container">
                    <ul class="nav-menu">
                        ...
                        <li><a href="#venue">Anuncios</a></li>
                        <li><a href="#hotels">Produtos</a></li>
                        <li><a href="#supporters">Parceiros</a></li>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src="{{asset('img/corrida.jpg')}}" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="{{asset('img/corrida.jpg')}}" alt="Second slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="{{asset('img/corrida.jpg')}}" alt="Third slide">
                    </div>
                </div>
        ...
        <main id="main">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <center>
                                <h2>Anna Jessica</h2>
                                <p>Radialista, Apresentadadora de Eventos Esportivos e Mestre de Cerimônias.</p>
                            </center>
                        </div>
                    </div>
                </div>
            ...
            <section id="speakers" class="wow fadeInUp">
                <div class="container">
                    <div class="section-header">
                        <h2>Portifolio</h2>
                        <p>Aqui você vera Alguns dos eventos realizados por mim.</p>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="speaker">
                                <img src="{{asset('img/corrida.jpg')}}" alt="Speaker 4" class="img-fluid">
                                <div class="details">
                                    <h3><a href="speaker-details.html">2º Nigth Bike MPE 2019</a></h3>
                                    <div class="social">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="speaker">
                                <img src="{{asset('img/corrida.jpg')}}" alt="Speaker 5" class="img-fluid">
                                <div class="details">
                                    <h3><a href="speaker-details.html">Corrida das Estações</a></h3>
                                    <div class="social">
                                        <a href=""><i class="fa fa-twitter"></i></a>
                                        <a href=""><i class="fa fa-facebook"></i></a>
                                        <a href=""><i class="fa fa-google-plus"></i></a>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="speaker">
                                <img src="{{asset('img/corrida.jpg')}}" alt="Speaker 6" class="img-fluid">
                                <div class="details">
            ...
            <section id="schedule" class="section-with-bg">
                <div class="container wow fadeInUp">
                    <div class="section-header">
                        ...
                        <p>Fique por dentro de todos os meus compromissos.</p>
                    </div>
                    ...
                    <h3 class="sub-heading">Estas datas podem ser alteradas ao decorrer da semana. Atualizações todas as terças.</h3>
                        ...
                        <div role="tabpanel" class="col-lg-9  tab-pane fade" id="day-2">
                            ...
                            <div class="row schedule                                    -item">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <h4>Texto texto <span>Alejandrin Littel</span></h4>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="hotel">
                                <div class="hotel-img">
                                    <img src="{{asset('img/kits.jpg')}}" alt="Hotel 1" class="img-fluid">
                                </div>
                                <h3><a href="#">Kit night bike</a></h3>
                                <div class="stars">
                                    <b>R$ 39,90</b>
                                </div>
                                <p>Cadastre-se para obter este produto.</p>
                            </div>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title text-muted text-uppercase text-center">Faça ja sua solicitação</h5>
                                    <h6 class="card-price text-center">Nigth bike</h6>
                                    <hr>
                                    <ul class="fa-ul">
                                        <li><span class="fa-li"><i class="fa fa-check"></i></span>Kit night bick</li>
                                        <li><span class="fa-li"><i class="fa fa-check"></i></span>Começa no epitacio society</li>
                                    </ul>
                                    <hr>
                                    <div class="text-center">
                                        <button type="button" class="btn" data-toggle="modal" data-target="#buy-ticket-modal" data-ticket-type="premium-access">Solicitar</button>
                                    </div>
            ...
            <section id="contact" class="section-bg wow fadeInUp">
                ...
                <div class="container">
                    ...
                    <div class="section-header">
                        <h2>Cadastro</h2>
                        <p>Faça seu cadastro para participar dos eventos.</p>
                    </div>
                        ...
                        <form action="" method="post" role="form" class="contactForm">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <input type="text" name="Nome" class="form-control" id="name" placeholder="Nome" data-rule="minlen:4" data-msg="texto texto texto" />
                                    <div class="validation"></div>
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="text" name="Telefone" class="form-control" id="name" placeholder="Telefone" data-rule="minlen:4" data-msg="texto texto texto" />
                                    <div class="validation"></div>
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="text" name="Email" class="form-control" id="name" placeholder="Email" data-rule="minlen:4" data-msg="texto texto texto" />
                                    <div class="validation"></div>
                                </div>
                                <div class="form-group col-md-6">
                                    <input type="email" class="form-control" name="Senha" id="email" placeholder="Senha" data-rule="email" data-msg="texto texto texto" />
                                    <div class="validation"></div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 footer-contact">
                            ...
                            <p>
                                ...
                                United States <br>
                                <strong>Numero:</strong> +55 (85) 98888-8888<br>
