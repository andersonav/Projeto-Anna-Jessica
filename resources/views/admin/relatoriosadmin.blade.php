                        ...
                        <div class="col-lg-4">
                            <div class="card" id="cardR">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <a href="{{route('pdfUsuarios')}}" target="_blank"><button class="btnmodal" id="btnGerarPdfUsuarios"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> &nbsp;Gerar</button></a>
                        ...
                        <div class="col-lg-4">
                            <div class="card" id="cardR">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <a href="{{route('pdfKits')}}" target="_blank"><button class="btnmodal" id="gerarPdfKits"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> &nbsp;Gerar</button></a>
                        ...
                        <div class="col-lg-4">
                            <div class="card" id="cardR">
                                <div class="card-body">
                                    ...
                                    <br>
                                    <a href="{{route('pdfEventosRealizados')}}" target="_blank"><button class="btnmodal" id="gerarPdfEventosRealizados"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> &nbsp;Gerar</button></a>
