                ...
                <div class="col-lg-12 venue-info">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-9">
                            ...
                            @endphp
                            @for ($i = 0; $i < count($idKit); $i++) @php $hashKit=bcrypt(md5($tamanho[$i].$idKit[$i].$nomeKit[$i].$valorKit[$i])); @endphp <div class="col-lg-12" id="kit">
                                <div class="row justify-content-center">
                                    <div class="col-lg-4 kitOk" id="{{ $idKit[$i] }}" role="img/eventos/kit/{{ $imagemKit[$i] }}">
                                        ...
                                        <center>
                                            <h6><b>Click na imagem para visualizar.</b></h6>
                                        </center>
                                    </div>
                                    <div class="col-lg-5" id="insc">
                                        <div class="col-lg-12">
